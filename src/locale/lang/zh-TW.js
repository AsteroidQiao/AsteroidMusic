export default {
  ...
  login: {
    ...
    notice: `AsteroidMusic 承諾不會保存您的任何帳戶資訊到雲端。<br />
        您的密碼會在本地進行 MD5 加密後再傳輸到網易雲 API。<br />
        AsteroidMusic 並非網易雲官方網站，輸入帳戶資訊前請慎重考慮。 您也可以前往
        <a href="https://github.com/AsteroidQiao/AsteroidMusic"
          >AsteroidMusic 的 GitHub 原始碼 Repo</a
        >
        自行編譯並使用自託管的網易雲 API。`,
    noticeElectron: `您的密碼會在本地進行 MD5 加密後再傳輸到網易雲 API。<br />
        AsteroidMusic 不會傳輸你的帳戶資料到任何非網易雲音樂官方的伺服器。<br />`,
  },
  mv: {
    moreVideo: '更多影片',
  },
